/**********************************************************/
/*                                                        */
/* diagbits1.c - Compute Monthly Payment                  */ 
/* given INT_RATE, LOAN_YEARS, and LOAN_AMT               */ 
/* and print summary to screen and the logfile            */
/* diagbits1_log.txt.                                     */ 
/*                                                        */ 
/* diagbits1.c - Read Status and Control Registers,       */ 
/* Environment Variables, and other parameters to         */ 
/* practice PC and Communications Network Diagnostics     */ 
/* skills. e.g. AMD E300 APU, CISCO DPC3825               */ 
/*                                                        */ 
/* gcc diagbits1.c -o diagbits1.exe                       */ 
/*                                                        */ 
/********************************************************************************************/
/*                                                                                          */
/* Example:                                                                                 */
...
/* declare variables for calendar and local time */ 
...
/* get the current calendar time  */
   ...
   printf("It is %d seconds since the Epoche\n", calendar_time); 
   
/* convert calendar time to local time */

   local_time = localtime( &calendar_time );
  
/* display date and time in the standard format */
...
/*  */ 
  ...
  pFile = fopen ("diagbits1_log.txt","w");
  ...
  printf("----------------------------------------------------------------- \n");
  printf("          Filename: diagbits1_log.txt:                            \n");
  printf("----------------------------------------------------------------- \n");
  
  printf("LOAN_AMT = %d LOAN_YEARS = %d INT_RATE = %f \n", LOAN_AMT,LOAN_YEARS,INT_RATE);
    
  fprintf(pFile, "----------------------------------------------------------------- \n");
  fprintf(pFile, "          Filename: diagbits1_log.txt                             \n");
  fprintf(pFile, "----------------------------------------------------------------- \n");
      
  fprintf(pFile, "The Date and Time is: %s\n", asctime( local_time ) ); 
